...
namespace RT::Client::Transitions
{
    ...
    void GameStart::init(std::shared_ptr<GE::ECS::EntityManager> entityManager)
    {
        GE::ECS::ComponentManager &componentManager = entityManager->getComponentManager();
        GE::ECS::Entity textEntity = entityManager->createEntity("assets/objects/transitions/gameStartText.json");
    ...
    void GameStart::update(std::shared_ptr<GE::ECS::EntityManager>)
    {
