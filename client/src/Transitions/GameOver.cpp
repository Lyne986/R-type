...
namespace RT::Client::Transitions
{
    ...
    void GameOver::init(std::shared_ptr<GE::ECS::EntityManager> entityManager)
    {
        GE::ECS::ComponentManager &componentManager = entityManager->getComponentManager();
        GE::ECS::Entity textEntity = entityManager->createEntity("assets/objects/transitions/gameOverText.json");
    ...
    void GameOver::update(std::shared_ptr<GE::ECS::EntityManager>)
    {
